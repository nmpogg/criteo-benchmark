...
### 1. Criteo
Kaggle Criteo Dataset [Display Advertising Challenge](https://go.criteo.net/criteo-research-kaggle-display-advertising-challenge-dataset.tar.gz)
...
**Lưu ý:** Nhãn (label) của file `test.txt` không được công bố, vì vậy ở đây chúng ta sẽ chia ngẫu nhiên `train.txt` thành các tập **train**, **dev** và **test**.
